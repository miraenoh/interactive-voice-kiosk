<template>
	<div class="center signup-form-container">
		...
		<vs-input v-model="password" type="password" label="비밀번호" placeholder="password"> </vs-input>
		<vs-input v-model="passwordConfirm" type="password" label="비밀번호 확인" placeholder="password">
		...
		<vs-input v-model="storename" class="my-input-storename" label="상호명" placeholder="킹고카페"> </vs-input>
